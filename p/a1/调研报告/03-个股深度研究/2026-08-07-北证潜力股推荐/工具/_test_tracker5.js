...
(async () => {
  ...
  const CFG = JSON.stringify({mcapMin:5,mcapMax:40,amountMin:3000,posMax:35,max5d:22,max10d:32,aiMin:50,topN:3,cap:12,aiOk:false,aiTop:5,kw:'机器,煤炭,锂,算力,光',autoScan:false,planTime:'15:35',minSurge:4,surgeVol:1.8,surgeDays:15,max20d:30,max60d:45,mainline:'must',hotPct:4,hotN:12,turnMin:2,turnMax:20,useFund:true});
