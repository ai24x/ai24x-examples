...
echo   Docs:        http://127.0.0.1:18031/docs
echo   Root 引导:   http://127.0.0.1:18031/   (JSON 内含 admin_login 等路径)
...
py -3 -m uvicorn app.main:app --host 127.0.0.1 --port 18031 --reload
if errorlevel 1 python -m uvicorn app.main:app --host 127.0.0.1 --port 18031 --reload
if errorlevel 1 (
  echo.
