...
> **版本**：v3.5.1 · 2026-07-26 · 文档汇总后与代码对齐  
> **策略**：Phase 1 国内验证 → Phase 2 国际；营销可并行储备  
...
| 阶段 | 市场 | 支付 | 文档 | 说明 |
|------|------|------|------|------|
| **Phase 1（当前）** | 国内付费验证 | 微信/支付宝（独立 notify）+ mock | 中文 | SMTP 邮箱注册；短信后置 |
| **Phase 2** | 国际 | PayPal/Stripe | 英文 | 海外节点 + OpenAI 兼容 |

Phase 1 **不做**：公共 Key 池、国际低延迟宣传、未测通的短信注册入口。
