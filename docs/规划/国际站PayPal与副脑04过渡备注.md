...
> 日期：2026-07-28 · **补记 2026-07-30** · **切流完成 2026-08-04**  
> 状态：**`www`+`api` 正式生产已在副脑04**；副脑03 Token 仅冷备份。PayPal Live / 国际库以 04 为准。  
...
1. **正式国际站**：副脑04 承接 `www.ai24x.com` + `api.ai24x.com`（Token 聚合）。  
2. **副脑03**：`a.ai24x.com` 行情官 + 微信/支付宝；Token/www/api **仅备份**，日常发版默认捅 **04**。  
3. **PayPal**：Live / 国际库在 04；中国主体卡体验限制保持现状不折腾。  
4. **管理后台** `token-admin` 可继续中文；用户站默认国际版（英文）。  
5. 发版：`docs/联调/Token发版-Gitee与副脑04.md`
...
| 域名 | 机器 | 说明 |
|------|------|------|
| `www.ai24x.com` | **副脑04**（正式） | 品牌站 / 控制台 / 英文默认 |
| `api.ai24x.com` | **副脑04** | Token / 登录 / **PayPal Live** / 国际库 |
| `a.ai24x.com` | **副脑03** | 行情官 + 微信/支付宝（Native 回调继续挂 a1） |

**节点策略**：国际入口 **1× 新加坡（04）**；不加美/欧主机，除非稳定流水 + 延迟/合规证据。

> 以下 §2 起为迁移前过渡记录，保留备查；执行以 §0 / §1 为准。

---

## 2. 开发顺序（历史 · 2026-07-30）

1. **本机**跑通主站 Token 全部功能模块并回归  
2. 整体迁 **副脑04**（同构；**已完成切流**）  
3. 不对用户承诺中国商户级卡体验  
4. **无独立预发机**：本机合格 → Gitee → **副脑04** 生产门禁  

**不要**为卡体验在 03 上反复改 PayPal 产品线 / Advanced。
