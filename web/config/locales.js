...
(function (global) {
  var zh = {
    ...
    "page.pricing.settleCnTitle": "本站（中文）",
    "page.pricing.settleCnBody": "微信、支付宝 · 人民币结算。现阶段以体验、联调、验履约为主。",
    "page.pricing.settleIntlTitle": "国际站",
  ...
  var en = {
    ...
    "page.pricing.settleCnTitle": "CN site (Chinese UI)",
    "page.pricing.settleCnBody": "WeChat / Alipay · CNY. For experience and payment testing.",
    "page.pricing.settleIntlTitle": "International site",
