...
(function (global) {
  var zh = {
    ...
    "page.index.c4t": "协作分润与透明规则",
    "page.index.c4p": "开放、透明、可追踪的协作与分润机制（以平台规则为准）。",
    "page.index.c5t": "邀请回馈 · 多通道充值",
    "page.index.c5p": "邀请有回馈；Token 充值支持微信、支付宝与 PayPal（USD），面向全球用户。",
    ...
    "page.console.chat.sub": "使用上方已保存的 API Key。可选档位：auto / flash / pro / ultra。",
    "page.console.chat.send": "发送",
    "page.console.chat.prompt": "Prompt",
    "page.console.chat.model": "档位",
  ...
  var en = {
    ...
    "page.index.c4t": "Transparent collaboration",
    "page.index.c4p":
      "Open collaboration with trackable settlement (per platform rules).",
    "page.index.c5t": "Referrals · multi-channel top-up",
    "page.index.c5p": "Clear invite rewards; top up Tokens via WeChat Pay, Alipay, or PayPal (USD).",
    ...
    "page.console.chat.sub": "Uses the API key saved above. Tiers: auto / flash / pro / ultra.",
    "page.console.chat.send": "Send",
    "page.console.chat.prompt": "Prompt",
    "page.console.chat.model": "Tier",
