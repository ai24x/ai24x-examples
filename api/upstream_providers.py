...
PROVIDERS: dict[str, dict[str, Any]] = {
    ...
    "mimo": {
        ...
        "free_key_env": "MIMO_API_KEY_FREE",
        "base_env": "MIMO_BASE_URL",
        "default_base": "https://api.xiaomimimo.com/v1",
        "enabled_env": "TOKEN_LLM_MIMO_FAILOVER",
        "covers": ["flash", "vip-mimo", "or_failover"],
        "note": "官方价=OR 价；单账号 100 RPM / TPM 10M，只做同模型兜底不扛量（2026-08-15 直连实测通过）。",
    },
    "together": {
