...
PROVIDERS: dict[str, dict[str, Any]] = {
    ...
    "openai_direct": {
        ...
        "covers": ["vip-gpt4o", "vip-gpt4o-mini"],
        "models": {"vip-gpt4o": "gpt-4o", "vip-gpt4o-mini": "gpt-4o-mini"},
    },
    "anthropic_direct": {
        "title": "Anthropic 直连",
        "role": "intl_direct",
        ...
        "covers": ["vip-claude-sonnet", "vip-claude-haiku"],
        "models": {
            "vip-claude-sonnet": "claude-sonnet-4-0",
            "vip-claude-haiku": "claude-haiku-4-0",
        },
    ...
    "google_direct": {
        ...
        "models": {
            "vip-gemini-pro": "gemini-2.0-flash",
            "vip-gemini-flash": "gemini-2.0-flash-lite",
        },
